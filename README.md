# Getting Started [![CI](https://github.com/daggerok/singleton-map-bean-dry-code/actions/workflows/ci.yaml/badge.svg)](https://github.com/daggerok/singleton-map-bean-dry-code/actions/workflows/ci.yaml)
